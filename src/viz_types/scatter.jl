function plot_numerical_attribute(attribute::NumericalAttribute, transactions::DataFrame, isantecedent::Bool)
...
function plot_numerical_feature(feature::NumericalFeature, transactions::DataFrame)
